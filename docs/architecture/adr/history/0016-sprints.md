...
- At the command surface through the bundle, the figure the read budget is judged on, `treadling show` at 50,000 items is 129,312 KiB before and 128,832 KiB after at the median of seven interleaved cold samples (before 128,368 to 129,712, after 127,904 to 130,224), read the same way from inside the process.
