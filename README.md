...
The suite ran 1,899 tests in 148 seconds on Node 24.11.1 on 2026-09-08, on a shared machine whose 1-minute load average was 20.87 when the run started and 20.29 when it ended, so the seconds are an upper bound rather than a quiet-machine baseline.
