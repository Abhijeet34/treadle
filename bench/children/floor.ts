...
// price Node's type stripper charges. The product ships a bundle (DR1) and this rig does
// not build one, so that gap is what separates these figures from DR1's.
